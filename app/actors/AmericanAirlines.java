...
public class AmericanAirlines extends AbstractActor {
    static public Props props() {
        return Props.create(AmericanAirlines.class, () -> new AmericanAirlines());
    }
    static Boolean fail;
    static Boolean noResponse;

    public AmericanAirlines() {
        System.out.println("Creating AmericanAirlines Actor");
        fail=false;
        noResponse=false;
    }
